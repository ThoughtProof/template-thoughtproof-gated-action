      ...
      <div className="flex items-center flex-col grow">
        ...
        <div className="w-full max-w-4xl mx-auto px-5 mt-8 pb-16">
          <div className="bg-base-100 rounded-2xl shadow-md p-8 border border-base-300 mb-8">
            <h3 className="font-bold text-lg mb-2 text-center">Gated HBAR hand</h3>
            <p className="text-base-content/70 text-sm text-center m-0 mb-6 max-w-2xl mx-auto">
              Agent proposes → off-chain gate ALLOW → <code className="text-xs">recordAllow</code> →{" "}
              <code className="text-xs">executeTransfer</code>. No funds move without a live unused receipt.
              Experiment bed — not production Sentinel. Not &quot;Hedera-verified reasoning.&quot;
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="rounded-xl bg-base-200 p-4">
                <p className="font-semibold m-0 mb-1">1. Agent</p>
                <p className="m-0 text-base-content/70">Builds proposalHash off-chain.</p>
              </div>
              <div className="rounded-xl bg-base-200 p-4">
                <p className="font-semibold m-0 mb-1">2. Gate</p>
                <p className="m-0 text-base-content/70">Verifier ALLOW → evidenceHash. BLOCK = no recordAllow.</p>
              </div>
              <div className="rounded-xl bg-base-200 p-4">
                <p className="font-semibold m-0 mb-1">3. Hand</p>
                <p className="m-0 text-base-content/70">
                  <code className="text-xs">GatedAction</code> executes only while ALLOW is live.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-base-100 rounded-2xl shadow-md p-8 text-center flex flex-col items-center hover:shadow-lg transition-shadow border border-base-300">
              ...
              <p className="text-base-content/70 text-sm m-0 mb-6">
                Call recordAllow / executeTransfer on GatedAction after deploy.
              </p>
          ...
          <div className="mt-8 bg-base-100 rounded-2xl shadow-md p-8 border border-base-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="m-0 font-medium">Test the gate contract</p>
                  <code className="text-xs bg-base-200 px-2 py-1 rounded">npm run hardhat:test</code>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-bold text-primary text-lg leading-none mt-0.5">2</span>
                <div>
                  <p className="m-0 font-medium">Primary contract</p>
                  <code className="text-xs bg-base-200 px-2 py-1 rounded">
                    packages/hardhat/contracts/GatedAction.sol
                  </code>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="m-0 font-medium">Deploy + demo gate flow</p>
